                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: Row(
                              children: [
                                GestureDetector(
                                  //from product page to cart page
                                  //from history page to cart page
                                  //cant view the product there came from history page
                                  onTap: () {
                                    var popularIndex =
